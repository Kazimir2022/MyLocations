...
class LocationsViewController: UITableViewController {
  ...
  lazy var fetchedResultsController: NSFetchedResultsController<Location> = {
    ...
    let sort1 = NSSortDescriptor(key: #keyPath(Location.category), ascending: true)
    let sort2 = NSSortDescriptor(key: #keyPath(Location.date), ascending: true)
    ...
    let fetchedResultsController = NSFetchedResultsController(
      ...
      sectionNameKeyPath: #keyPath(Location.category),
      cacheName: "Locations")
